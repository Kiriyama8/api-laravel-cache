...
class CourseTest extends TestCase
{
    ...
    {
        $response = $this->getJson('/courses/not_found');
    ...
    public function test_create_empty_course()
    {
    ...
    {
        $response = $this->postJson('/courses', [
            'name' => 'Novo Curso 2021'
        ]);

        $response->assertStatus(201);
    }

    public function test_update_empty_course()
    {
        $course = Course::factory()->create();
    ...
    {
        $response = $this->putJson('/courses/undefined', [
    ...
    {
        $response = $this->deleteJson('/courses/undefined');
